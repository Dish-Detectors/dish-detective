...
export default function PollResultsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <Box sx={{
            ...
            <Box sx={{ p: { xs: 2, md: 4 }, pb: 0, maxWidth: 900, mx: "auto", width: "100%" }}>
                <Button
                    startIcon={<ArrowBackIcon />}
                ...
                <Box sx={{ maxWidth: 900, mx: "auto" }}>
                    <Box sx={{ mb: 4 }}>
                        ...
                        <Typography color="text.secondary">
                            Kreirano: {formatDate(poll.createdAt)} • Ukupno odgovora: <strong>{totalAnswers}</strong>
                        </Typography>
                    </Box>
                    ...
                    {totalAnswers === 0 ? (
                        ...
                        <Stack spacing={4}>
                            {results.map((result: any, index: number) => (
                                <Paper key={index} sx={{ p: { xs: 2, md: 4 }, borderRadius: 3 }}>
