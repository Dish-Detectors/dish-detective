...
import { checkNotificationPermission, requestNotificationPermission } from "@/utils/fcmClient";
import { getUserSubscriptions, syncDeviceSubscriptions } from "@/actions/notification";
...
export default function NotificationSync() {
    ...
    return (
        <Snackbar
            ...
            action={
                <React.Fragment>
                    <Button color="secondary" size="small" onClick={handleSync} disabled={loading}>
                        OMOGUĆI
                    </Button>
                    <IconButton
                        size="small"
